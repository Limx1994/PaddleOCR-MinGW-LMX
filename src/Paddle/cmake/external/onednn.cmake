...
elseif(MINGW)
  set(ONEDNN_CXXFLAG "${CMAKE_CXX_FLAGS} -Wa,-mbig-obj")
  set(ONEDNN_CFLAG "${CMAKE_C_FLAGS} -Wa,-mbig-obj")
  set(ONEDNN_CXXFLAG_RELEASE "${CMAKE_CXX_FLAGS_RELEASE}")
  set(ONEDNN_CFLAG_RELEASE "${CMAKE_C_FLAGS_RELEASE}")
  set(ONEDNN_LIB
...
if(WIN32)
  if(MINGW)
    # MinGW: 直接使用静态库，无需生成 .lib
    set(ONEDNN_SHARED_LIB ${ONEDNN_INSTALL_DIR}/lib/libdnnl.a)
    add_custom_target(onednn_cmd ALL DEPENDS ${ONEDNN_PROJECT})
  else()
