...
if(NOT WIN32 OR MINGW)
  ...
  set(OPTIONAL_ARGS "")
  if(MINGW)
    # MinGW: specify TARGET explicitly since CPU detection fails
    set(OPTIONAL_ARGS TARGET=HASWELL)
  elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "^x86(_64)?$")
  ...
  # openblas uses Makefiles, not Ninja. Use mingw32-make on Windows.
  if(MINGW AND CMAKE_MAKE_PROGRAM MATCHES "ninja")
    get_filename_component(_MINGW_BIN_DIR "${CMAKE_C_COMPILER}" DIRECTORY)
    set(OPENBLAS_MAKE "${_MINGW_BIN_DIR}/mingw32-make.exe")
  else()
    set(OPENBLAS_MAKE ${CMAKE_MAKE_PROGRAM})
  endif()
  ExternalProject_Add(
    extern_openblas
    ...
    BUILD_IN_SOURCE 1
    BUILD_COMMAND ${OPENBLAS_MAKE} ${ARM_ARGS} -s -j${NPROC} ${COMMON_ARGS} ${OPTIONAL_ARGS}
    INSTALL_COMMAND ${OPENBLAS_MAKE} install NO_SHARED=1 NO_LAPACK=1 PREFIX=<INSTALL_DIR>
    UPDATE_COMMAND ""
    CONFIGURE_COMMAND ""
    BUILD_BYPRODUCTS ${CBLAS_LIBRARIES})
  set(OPENBLAS_SHARED_LIB
      ${CBLAS_INSTALL_DIR}/lib/libopenblas${CMAKE_SHARED_LIBRARY_SUFFIX})
else()
  set(CBLAS_LIBRARIES
