...
if(NOT "${PROTOBUF_ROOT}" STREQUAL "")
  ...
  if(MINGW)
    find_library(
      PROTOBUF_LIBRARY protobuf libprotobuf.a
      PATHS ${PROTOBUF_ROOT}/lib
      NO_DEFAULT_PATH)
    find_library(
      PROTOBUF_LITE_LIBRARY protobuf-lite libprotobuf-lite.a
      PATHS ${PROTOBUF_ROOT}/lib
      NO_DEFAULT_PATH)
    find_library(
      PROTOBUF_PROTOC_LIBRARY protoc libprotoc.a
      PATHS ${PROTOBUF_ROOT}/lib
      NO_DEFAULT_PATH)
  else()
    find_library(
...
function(build_protobuf TARGET_NAME)
  ...
  if(WITH_ARM_BRPC)
    ...
    ExternalProject_Add(
      ...
      UPDATE_COMMAND ""
      PATCH_COMMAND
      COMMAND cd ${SOURCE_DIR} && (git checkout ${PROTOBUF_TAG} || true)
      DEPENDS zlib
      CONFIGURE_COMMAND
