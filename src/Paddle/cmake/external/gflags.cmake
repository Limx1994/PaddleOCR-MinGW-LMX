...
if(WIN32)
  ...
  set(_os_dep_modules)
  if(HAVE_SHLWAPI)
    list(APPEND _os_dep_modules shlwapi.lib)
  endif()
  # dbghelp is needed by glog for symbolization on Windows
  list(APPEND _os_dep_modules dbghelp.lib)
  set_property(GLOBAL PROPERTY OS_DEPENDENCY_MODULES ${_os_dep_modules})
endif()
