...
if(NOT WITH_SETUP_INSTALL)
  ...
  # Skip submodule sync for MinGW builds (network issues)
  if(NOT MINGW)
    ...
    message(STATUS "Skipping submodule sync for MinGW build")
  endif()

  if(MINGW)
    message(STATUS "Skipping all submodule updates for MinGW build")
    set(result_var 0)
