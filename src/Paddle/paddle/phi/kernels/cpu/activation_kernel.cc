...
// MinGW GCC: explicit template instantiation to prevent GCC from inlining
// these templates to local symbols, which causes undefined reference errors
// when sparse kernels call dense kernels.
#if defined(__MINGW64__) || defined(__MINGW32__)
#define EI(name) \
  template void name##Kernel<float, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*); \
  template void name##Kernel<double, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);

EI(Relu) EI(Sqrt) EI(Sin) EI(Cos) EI(Tan) EI(Asin) EI(Atan) EI(Acos)
EI(Sinh) EI(Cosh) EI(Asinh) EI(Acosh) EI(Atanh) EI(Tanh) EI(TanhShrink)
EI(Silu) EI(Reciprocal) EI(Square) EI(Rsqrt) EI(Softsign) EI(Sigmoid)
EI(LogSigmoid) EI(Floor) EI(Ceil) EI(Negative)

// Complex types for kernels that support them
template void SinKernel<dtype::complex<float>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void SinKernel<dtype::complex<double>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void CosKernel<dtype::complex<float>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void CosKernel<dtype::complex<double>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void TanKernel<dtype::complex<float>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void TanKernel<dtype::complex<double>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void AsinKernel<dtype::complex<float>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void AsinKernel<dtype::complex<double>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void SqrtKernel<dtype::complex<float>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void SqrtKernel<dtype::complex<double>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void AtanhKernel<dtype::complex<float>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void AtanhKernel<dtype::complex<double>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void AsinhKernel<dtype::complex<float>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void AsinhKernel<dtype::complex<double>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void AcoshKernel<dtype::complex<float>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void AcoshKernel<dtype::complex<double>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void TanhKernel<dtype::complex<float>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void TanhKernel<dtype::complex<double>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void AtanKernel<dtype::complex<float>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void AtanKernel<dtype::complex<double>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void AcosKernel<dtype::complex<float>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void AcosKernel<dtype::complex<double>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void SinhKernel<dtype::complex<float>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void SinhKernel<dtype::complex<double>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void CoshKernel<dtype::complex<float>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
template void CoshKernel<dtype::complex<double>, CPUContext>(const CPUContext&, const DenseTensor&, DenseTensor*);
