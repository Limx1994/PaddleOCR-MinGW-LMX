...
namespace phi { namespace sparse {
template void MaskAsCooKernel<float, CPUContext>(const CPUContext&, const DenseTensor&, const SparseCooTensor&, SparseCooTensor*);
template void MaskAsCooKernel<double, CPUContext>(const CPUContext&, const DenseTensor&, const SparseCooTensor&, SparseCooTensor*);
template void MaskAsCooKernel<int, CPUContext>(const CPUContext&, const DenseTensor&, const SparseCooTensor&, SparseCooTensor*);
template void MaskAsCooKernel<int64_t, CPUContext>(const CPUContext&, const DenseTensor&, const SparseCooTensor&, SparseCooTensor*);
template void MaskAsCooKernel<int16_t, CPUContext>(const CPUContext&, const DenseTensor&, const SparseCooTensor&, SparseCooTensor*);
template void MaskAsCooKernel<int8_t, CPUContext>(const CPUContext&, const DenseTensor&, const SparseCooTensor&, SparseCooTensor*);
template void MaskAsCooKernel<uint8_t, CPUContext>(const CPUContext&, const DenseTensor&, const SparseCooTensor&, SparseCooTensor*);
template void MaskAsCooKernel<bool, CPUContext>(const CPUContext&, const DenseTensor&, const SparseCooTensor&, SparseCooTensor*);
template void MaskAsCooKernel<phi::dtype::complex<float>, CPUContext>(const CPUContext&, const DenseTensor&, const SparseCooTensor&, SparseCooTensor*);
template void MaskAsCooKernel<phi::dtype::complex<double>, CPUContext>(const CPUContext&, const DenseTensor&, const SparseCooTensor&, SparseCooTensor*);
template void MaskHelperCooKernel<float, CPUContext>(const CPUContext&, const SparseCooTensor&, const DenseTensor&, DenseTensor*);
template void MaskHelperCooKernel<double, CPUContext>(const CPUContext&, const SparseCooTensor&, const DenseTensor&, DenseTensor*);
template void MaskHelperCooKernel<int, CPUContext>(const CPUContext&, const SparseCooTensor&, const DenseTensor&, DenseTensor*);
template void MaskHelperCooKernel<int64_t, CPUContext>(const CPUContext&, const SparseCooTensor&, const DenseTensor&, DenseTensor*);
template void MaskHelperCooKernel<int16_t, CPUContext>(const CPUContext&, const SparseCooTensor&, const DenseTensor&, DenseTensor*);
template void MaskHelperCooKernel<uint8_t, CPUContext>(const CPUContext&, const SparseCooTensor&, const DenseTensor&, DenseTensor*);
template void MaskHelperCooKernel<phi::dtype::float16, CPUContext>(const CPUContext&, const SparseCooTensor&, const DenseTensor&, DenseTensor*);
template void MaskHelperCooKernel<phi::dtype::complex<float>, CPUContext>(const CPUContext&, const SparseCooTensor&, const DenseTensor&, DenseTensor*);
template void MaskHelperCooKernel<phi::dtype::complex<double>, CPUContext>(const CPUContext&, const SparseCooTensor&, const DenseTensor&, DenseTensor*);
}}  // namespace phi::sparse
#endif
