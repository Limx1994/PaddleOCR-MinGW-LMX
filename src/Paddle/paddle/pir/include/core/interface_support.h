...
// Windows headers define 'interface' as a macro, which conflicts with our usage
// We need to undefine it before including any headers
#ifdef interface
#undef interface
#endif
...
// Ensure interface is not redefined by any included headers
#ifdef interface
#undef interface
#endif
