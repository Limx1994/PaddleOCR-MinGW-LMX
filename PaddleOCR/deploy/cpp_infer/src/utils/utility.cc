...
#else
  // MinGW/Clang: use cpuid.h
  char cpuBrand[0x40] = {0};
  unsigned int cpuInfo[4] = {0};
  __cpuid_count(0x80000002, 0, cpuInfo[0], cpuInfo[1], cpuInfo[2], cpuInfo[3]);
  memcpy(cpuBrand, cpuInfo, sizeof(cpuInfo));
  __cpuid_count(0x80000003, 0, cpuInfo[0], cpuInfo[1], cpuInfo[2], cpuInfo[3]);
  memcpy(cpuBrand + 16, cpuInfo, sizeof(cpuInfo));
  __cpuid_count(0x80000004, 0, cpuInfo[0], cpuInfo[1], cpuInfo[2], cpuInfo[3]);
  memcpy(cpuBrand + 32, cpuInfo, sizeof(cpuInfo));
  std::string brandStr(cpuBrand);
#endif
